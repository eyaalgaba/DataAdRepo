...
<body>
    ...
    <?php
        ...
        ?>
    <div class="container-fluid" style="background-color: #4540A2; height: 583px; border-radius: 30px 30px 0 0;">
        ...
        <!-- Delete Button -->
        <form method = "post"> 
            <div class="row p-5 deleteButton" style="text-align: right;">
            <a href="index.php"> <button on-click type="submit" name="deleteButton" class="btn custom-btn btn-lg"
